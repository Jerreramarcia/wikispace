                ...
                <ul>
                    ...
                    <li>
                        <div id="commentario">
                            <h1>Crear Noticia</h1>
                            <div id="texto">
                                <form method="post" action="publicarnoticia.php">
                    ...
                    $db = new database();
                    $db = $db->connect();
                    $result = mysqli_query($db,"SELECT * FROM new  ORDER BY idnew DESC");
                    while($var = mysqli_fetch_array($result)){
                        ...
                        <li>
                            <div>
                                ...
                                <p><?php echo $var[3] ?></p>
                                <a href="noticia.php?idnew=<?php echo $var[0] ?>" class="more" >Leer</a>
                            </div>
                        </li>
                        <?php
                    }
